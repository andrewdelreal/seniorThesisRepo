...
const clusterController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { date, numClusters, dimensions, boolIsLog, boolIsStandardized, exchanges, dimensionReduction } = req.body;
    ...
    const data = yield (0, clusterServices_1.cluster)(date, numClusters, dimensions, boolIsLog, boolIsStandardized, exchanges, dimensionReduction);
    res.status(200).json({
        success: true,
        data,
    });
